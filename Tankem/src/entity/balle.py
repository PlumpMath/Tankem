...
class Balle(ShowBase):
    ...
    def __init__(self, gamelogic, identifiantLanceur,mondePhysique):
#######################################AJOUTER #########################################
        self.gameLogic = gamelogic
        self.canonVitesseBalle=self.gameLogic.unDTO.getValue("canonVitesseBalle")
        self.mitrailletteVitesseBalle=self.gameLogic.unDTO.getValue("mitrailletteVitesseBalle")
        self.grenadeVitesseInitialeBalle=self.gameLogic.unDTO.getValue("grenadeVitesseInitialeBalle")
        self.shotgunVitesseBalle=self.gameLogic.unDTO.getValue("shotgunVitesseBalle")
        self.missileGuideVitesseBalle=self.gameLogic.unDTO.getValue("missileGuideVitesseBalle")
        self.explosionBallesGrosseur=self.gameLogic.unDTO.getValue("explosionBallesGrosseur")
        self.piegeVitesseBalle = self.gameLogic.unDTO.getValue("piegeVitesseBalle")
    ...
    def exploser(self):
        if(self.etat == "actif"):
            ...
            grosseurScaleFinal = self.explosionBallesGrosseur
    ...
    def projetter(self, position, direction):
        ...
        vitesseBalle = self.canonVitesseBalle
    ...
    def projetterRapide(self, position, direction):
        ...
        self.noeudPhysique.node().setFriction(0.0)
        self.noeudPhysique.node().setRestitution(2.0)
        vitesseBalle = self.mitrailletteVitesseBalle
        self.noeudPhysique.node().applyCentralImpulse(direction * vitesseBalle)
        self.mondePhysique.attachRigidBody(self.noeudPhysique.node())
    ...
    def projetterVariable(self, position, direction):
        ...
        self.noeudPhysique.node().setFriction(0.0)
        self.noeudPhysique.node().setRestitution(2.0)
        vitesseBalle = self.shotgunVitesseBalle
        self.noeudPhysique.node().applyCentralImpulse(direction * vitesseBalle)
        self.mondePhysique.attachRigidBody(self.noeudPhysique.node())
    ...
    def deposer(self, position, direction):
        ...
        vitesseBalle = self.piegeVitesseBalle
        self.noeudPhysique.node().applyCentralImpulse(direction * vitesseBalle)
        self.mondePhysique.attachRigidBody(self.noeudPhysique.node())
    ...
    def lancer(self, position, direction, vitesseInitialeBalle = 16):
        self.etat = "actif"
        vitesseInitialeBalle= self.grenadeVitesseInitialeBalle
    ...
    def lancerSurCible(self,noeudCible):
        ...
        vitesseInitialeBalle = self.missileGuideVitesseBalle
